...
INSERT INTO ARTICLE(contents, local_date_time, modified_date_time, subject, user_id)  VALUES ('글 내용입니다', now(), now(), '글 제목입니다', 1);
INSERT INTO ARTICLE(contents, local_date_time, modified_date_time, subject, user_id)  VALUES ('김민정 게시글입니다', now(), now(), '두번쨰 제목입니다', 2);
INSERT INTO ARTICLE(contents, local_date_time, modified_date_time, subject, user_id)  VALUES ('문상일 게시글입니다', now(), now(), '세번째 제목입니다', 3);
